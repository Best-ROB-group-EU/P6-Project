...
SIDEWALK_CLASSES = ('cobblestone', 'tile', 'sidewalk')


sidewalk_dataset = dataset_base.copy({
    'name': 'Sidewalk Dataset',

    'train_images': './data/sidewalk/images/',
    'train_info':   './data/sidewalk/annotations/sidewalk_coco.json',

    'valid_images': './data/sidewalk/images/',
    'valid_info':   './data/sidewalk/annotations/sidewalk_coco.json',

    'has_gt': True,
    'class_names': SIDEWALK_CLASSES,
...
coco2017_dataset = dataset_base.copy({
    ...
    'train_info': './data/coco/annotations/image_info_test2017.json',
    'valid_info': './data/coco/annotations/image_info_test2017.json',
